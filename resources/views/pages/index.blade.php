    ...
    <div id="lower_page">
        <div id="lower_left">
            <div class="blogheader">
                <h2><a href="/single">This is your first blog entry</a></h2>
                <h3>posted by Jack on December 5th, 2006</h3>
            </div>
            ...
            <div class="post_summary">
                <ul>
                    ...
                    <li><a href="#"> <span class="ps_title">Cras sagittis. Pellentesque dictum bibendum leo.</span> <br />
        ...
        <div id="lower_right">
            ...
            <p>This template includes a contact page (click the contact link in the menu), and a single story page (click the first blog entry to the left).</p>
            <p>The header image was drawn by the extremely talented artist Jacob Sjoman and he graciously allowed me to use it.</p>
